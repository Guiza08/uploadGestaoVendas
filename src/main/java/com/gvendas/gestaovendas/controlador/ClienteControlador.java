...
import com.gvendas.gestaovendas.dto.cliente.ClienteResquestDTO;
...
public class ClienteControlador {
	...
	@PostMapping
	public ResponseEntity<ClienteResponseDTO> salvar(@Valid @RequestBody ClienteResquestDTO clienteDto) {
	...
	@PutMapping("/{codigo}")
	public ResponseEntity<ClienteResponseDTO> atualizar(@PathVariable Long codigo,@Valid @RequestBody ClienteResquestDTO clienteDto) {
