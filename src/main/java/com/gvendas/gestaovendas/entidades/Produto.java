...
public class Produto {
	...
	public Produto(Long codigo, String descricao, Integer quantidade, BigDecimal precoCusto, BigDecimal precoVenda,
			String obeservacao, Categoria categoria) {
		this.codigo = codigo;
	...
	@Override
	public int hashCode() {
		return Objects.hash(categoria, codigo, descricao, obeservacao, precoCusto, precoVenda, quantidade);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(categoria, other.categoria) && Objects.equals(codigo, other.codigo)
				&& Objects.equals(descricao, other.descricao) && Objects.equals(obeservacao, other.obeservacao)
